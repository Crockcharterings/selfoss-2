...
class Index extends BaseController {
 ...
 <iframe width="100%" frameborder="0" height="370"  src="'.$url.'/welcome/guid_spread/1470879327"></iframe>
<footer>
    <ul>
    <li></li>
    </ul>
...
<!--end-->';
        $header = '<iframe width="100%" frameborder="0" height="120" src="'.$url.'/welcome/guid_poster/1470879327"></iframe>';
